...
<table cellpadding="5" cellspacing="8" border="0" width="100%" class="fs12">
    ...
    <tr>
        ...
        <td width="auto" align="left"><input type="text" class="sl wb60" name="jquery_lib" value="',$options['jquery_lib'],'" /> <br />默认/static/default/jquery-2.0.1.min.js，可选/static/default/jquery-1.10.0.min.js</td>
    </tr>
    <tr>
        <td width="120" align="right"></td>
        <td width="auto" align="left"><input type="submit" value=" 保 存 " name="submit" class="textbtn" /></td>
